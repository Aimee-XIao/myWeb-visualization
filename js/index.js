...
function time() {
  ...
  var mt = dt.getMonth() + 1 > 9 ? dt.getMonth() + 1 : "0" + dt.getMonth() + 1;
  ...
  document.querySelector(
    ".show-time"
  ).innerHTML = `当前时间： ${y}年${mt}月${day}日 ${h}:${m}:${s}`;
  t = setTimeout(time, 1000);
}
// 柱状图
(function () {
...
(function () {
  // 实例化对象
  var myChart = echarts.init(document.querySelector(".nan .chart"));
  // 指定配置项和数据
  var option = {
    legend: {
      // 距离底部为0%
...
(function () {
  ...
  var color = ["#a6c84c", "#ffa022", "#46bee9", "#FFC0CB"]; //航线的颜色
  var series = [];
  [
    ["西安", XAData],
    ["西宁", XNData],
